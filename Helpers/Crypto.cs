...
namespace vaYolo.Helpers
{
    public class Crypto
    {
        private const string KeyString = "vavabvfaergfdbgvgfthsbgzdgfaergsdbgghdjyukjhytq54mkhjuyfkutyrysfstw4eryfrnmtyimogopiulfudtyregwehiftyukgyjthsy57e687irfuoyklgjhj";
